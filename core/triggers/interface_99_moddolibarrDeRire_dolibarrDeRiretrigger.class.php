...
/**
 * 	\file		core/triggers/interface_99_modMyodule_dolibarrDeRiretrigger.class.php
 ...
 * Trigger class
 */
class InterfacedolibarrDeRiretrigger
{
    ...
    public function run_trigger($action, $object, $user, $langs, $conf)
    {
        ...
        elseif ($action == 'CONTACT_CREATE') {
            ...
            TContactPicturesAnalyse::setFields($object);
            dol_syslog(
                "Trigger '" . $this->name . "' for action '$action' launched by " . __FILE__ . ". id=" . $object->id
            );
