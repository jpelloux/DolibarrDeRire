 ...
 */
class dolibarrderirebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "dolibarrderire@dolibarrderire";
    public $boxlabel;
    public $depends = array("dolibarrderire");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/dolibarrderire/class/dolibarrderire.class.php";
